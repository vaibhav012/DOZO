...
public class Level7 extends AppCompatActivity {
    ...
    public static final int beginBlack = 3;
    private final long startTime = 6 * 1000;
    private final long interval = 1 * 1000;
    private final int LEVEL_ID = 7;
    int i = 0, j = 0;
    int score=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttons[4][0] = (Button) findViewById(R.id.button17);
        buttons[4][1] = (Button) findViewById(R.id.button18);
        buttons[4][2] = (Button) findViewById(R.id.button19);
        buttons[4][3] = (Button) findViewById(R.id.button20);
